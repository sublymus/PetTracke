...
export function ScaneInfo() {
    ...
    const { json, current, navBack, qs } = useAppRouter();
    ...
    useEffect(() => {
        current('pet_profile') && j.owner && fetchCodes({
            animal_id: j.animal?.id,
            no_save: true,
        }).then(res => {
            setCodes(res)
        })
            ...
            <div className="ctn">
                ...
                <div className="animal-info">
                    ...
                    <div className="info">
                        ...
                        <div className='t'>{_L('age')} : <span>{j.animal.age}</span></div>
